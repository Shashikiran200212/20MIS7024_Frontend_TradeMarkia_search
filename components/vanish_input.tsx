  ...
  return (
    ...
    >
      ...
      <button
        disabled={!value}
        type="submit"
        className="absolute right-2 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full bg-blue-500  transition duration-200 flex items-center justify-center"
      >
        <motion.svg
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className=" text-sm sm:text-base font-normal text-blue-500 pl-4 sm:pl-10 text-left w-[calc(100%-2rem)] truncate"
            >
